...
public class RenderData {
    ...
    public boolean hasColour;     // True when we have color values
    public boolean hasNormal;     // True when we have normal values
    public boolean hasTexture;    // True when we have texture coordinates
